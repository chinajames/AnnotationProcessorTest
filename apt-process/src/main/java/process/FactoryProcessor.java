...
public class FactoryProcessor extends AbstractProcessor {
    ...
    public synchronized void init(ProcessingEnvironment processingEnv) {
        ...
        stringBuffer.append(String.format("\n%s Annotation Processor",this.getClass().getSimpleName()));
    }
    ...
    public Set<String> getSupportedAnnotationTypes() {
        ...
        stringBuffer.append(String.format("getSupportedAnnotationTypes %s",Factory.class.getCanonicalName()));
        return annotataions;
    }
    ...
    public boolean process(Set<? extends TypeElement> annotations, RoundEnvironment roundEnv) {
        ...
        try {
            ...
            for (Element annotatedElement : roundEnv.getElementsAnnotatedWith(Factory.class)) {
                stringBuffer.append(String.format("\nannotatedElement = %s getKind = %s",annotatedElement.toString(),annotatedElement.getKind()));
